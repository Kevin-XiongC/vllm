...
class Request:
    def __init__(
        ...
        # Holds the prefill-side cached-token count surfaced by the KV
        # connector for PD-disaggregated deployments. -1 means "not yet
        # resolved"; resolves lazily via num_cached_tokens_for_output.
