    ...
    def _dummy_run(
        ...
        with self.synchronize_input_prep():
            ...
            if force_attention or cudagraph_runtime_mode == CUDAGraphMode.FULL:
                ...
                # Attention metadata may be built with padded requests during
                # dummy/cudagraph warmup. Keep padded query offsets monotonic so
                # builders see zero-length requests instead of stale values.
